...
*** Налаштування ***
Документація      Понад поріг: повна відкрита процедура, відгалуження за
...               відгалуженням.
...
...               Запланована закупівля стає закупівлею з критеріями, щодо
...               неї ставлять звернення й відповідають на них, і проти неї
...               подають шість скарг - кожну доводять до іншого завершення,
...               щоб кожен кінцевий статус, якого скарга може досягти, був
...               пройдений один раз. Далі двоє учасників змагаються в
...               аукціоні, а визначення переможців навмисно нерівне: одного
...               переможця підтверджують і на нього скаржаться, одного
...               скасовують після факту, одному відмовляють, а четвертого
...               підтверджують. Те, що лишилось, стає договорами, які
...               підписують, змінюють і закривають.
...
Тестові теги      procedure:aboveThreshold    smoke    slow
